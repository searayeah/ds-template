...
uv add pre-commit isort "bandit[toml]" black flake8 flake8-bugbear flake8-simplify flake8-pyproject ruff mypy pylint deptry "nbqa[toolchain]" --dev --raw-sources
